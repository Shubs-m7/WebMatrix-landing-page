...
>(({ children, className, activeSlide: controlledActiveSlide, onSlideChange, ...props }, ref) => {
  const [localActiveSlide, setLocalActiveSlide] = React.useState<number>(0)
  
  const activeSlide = controlledActiveSlide !== undefined ? controlledActiveSlide : localActiveSlide;
  ...
  const changeSlide = React.useCallback(
    ...
    [controlledActiveSlide, onSlideChange]
  )
  return (
